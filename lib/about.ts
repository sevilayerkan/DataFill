...
export const aboutFaqs = [
  ...
  },
  {
    ...
    answer:
      "Lorem ipsum generation by character count, character / word / line counter, case converter, whitespace cleaner, Base64 encode and decode, text diff, secure password generator, fake name, email, address and phone generation, plus a dataset builder for test fixtures.",
  },
];
